...
let elementText = '<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-md-6 g-3 mx-auto">';
...
for (let i = 1; i <= elementNumber; i++){
    ...
    // 3. Aggiungo all'interno del ciclo le condizioni di elementText se un numero è perfettamente divisibile per 3, 5 e 15
    if (i % 3 === 0) elementText += `<div class="col"><div class="my-card fizz">Fizz</div></div>`;
    if (i % 5 === 0) elementText += `<div class="col"><div class="my-card buzz">Buzz</div></div>`;
    if (i % 15 === 0) elementText += `<div class="col"><div class="my-card fizzbuzz">FizzBuzz</div></div>`;
}
